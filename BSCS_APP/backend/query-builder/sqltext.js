module.exports = {
    sqlText: {
        ...
        RITAB: `SELECT :1 digits, RIM.RICODE RI, RI.DES RIDES, RIM.VSCODE RIVS, RV1.VSDATE RIVSD, MAX(RV2.VSCODE) MAXRIVS, RV1.UPCODE UP,
        ...
        WH_RITAB_MAXV: `AND RIM.VSCODE = (SELECT MAX(VSCODE) FROM MPULKRIM WHERE RICODE = RIM.RICODE AND GVCODE = :2 AND ZNCODE = :4)
                `,
